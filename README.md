...
- [adapterkit/adapterkit](https://github.com/adapterkit/adapterkit) ([v1.5.0](https://github.com/adapterkit/adapterkit/releases/tag/v1.5.0), today) - multi-purpose, extensible mechanism for managing jobs and commands
