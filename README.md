...
- [adapterkit/adapterkit](https://github.com/adapterkit/adapterkit) ([v1.5.2](https://github.com/adapterkit/adapterkit/releases/tag/v1.5.2), 4 days ago) - multi-purpose, extensible mechanism for managing jobs and commands
