...
- [adapterkit/adapterkit](https://github.com/adapterkit/adapterkit) ([v1.4.1](https://github.com/adapterkit/adapterkit/releases/tag/v1.4.1), 3 days ago) - multi-purpose, extensible mechanism for managing jobs and commands
